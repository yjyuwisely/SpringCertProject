...
public class CertificateController {
	...
	public String InoutDown(Model model, CertificateVO member, HttpSession session){
	...
	//수술확인서
	@GetMapping("/SergDown")
	public String SergDown(Model model, CertificateVO member, HttpSession session){
